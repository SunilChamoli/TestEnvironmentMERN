...
const formatTime = (timeInSeconds) => {
  ...
  const QuizHeader = ({ timer }) => {
    ...
    return (
      <section className="shadow-sm my-5 py-2 sticky top-0 bg-white z-1 " id="alertContainer">
        <div className="w-9/12 mx-auto flex md:flex-row flex-col justify-between items-center">
          <div className="font-normal">
            <span className="text-red-700">Attention!</span> You have 10 min to
            answer 6 questions.
            <br />
          ...
          <div className="flex items-center">
            ...
            <div className="text-left">
              ...
              <p className="text-xs -mt-1 text-gray-700">Time Left</p>
            </div>
          </div>
        </div>
      </section>
